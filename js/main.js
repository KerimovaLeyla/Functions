...
//   TASK1.ID-ə görə ölkəni tapan function yazın.
//     let a;
//     function country(id) {
//     a=work.find(item=>item.id===id);
//     console.log(a.shipAddress.country);
// }

// TASK2.Ölkəyə görə obyekti tapa function yazın.
//    let a;
//    function object(x) {
//    a=work.filter(item=>item.shipAddress.country===x);
//    console.log(a);
//    }

// TASK3.ID-ə görə shipName , Country və City tapan function yazın.

//     function Function(id) {
//     let a=work.find(item=>item.id===id);
//     console.log(a.shipName);
//     console.log(a.shipAddress.country);
//     console.log(a.shipAddress.city);   
// }
     
// TASK4.ID-ə görə neçə növdə satış edildiyini göstərən function yazın. (details sayı)
...
// TASK5.ID-görə bir obyektin toplam qazancını tapan function yazın. (discount daxil)
//     let  b;
//     function profit(id){
//     let a=work.find(item=>item.id===id);
//     console.log(b.details[0].quantity*a.details[0].unitPrice*(1-a.details[0].discount));
